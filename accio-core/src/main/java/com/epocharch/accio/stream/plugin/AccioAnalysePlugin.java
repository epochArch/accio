 ...
 */
public class AccioAnalysePlugin extends Statistics implements AnalystStream {
    AccioCommonAnanlyse accioCommonAnanlyse=new AccioCommonAnanlyse();

    public AnalystStream analyse(Object object){
        AccioCommonWrapper accioCommonWrapper =(AccioCommonWrapper)object;
        accioCommonAnanlyse.setServiceMethodName(accioCommonWrapper.getServiceMethodName());
        accioCommonAnanlyse.setAppHost(accioCommonWrapper.getAppHost());
        accioCommonAnanlyse.setAppCode(accioCommonWrapper.getAppName());
        accioCommonAnanlyse.setAppType(accioCommonWrapper.getAppType());
        return this;
    }
    ...
    public Object toEntity(){
        if(accioCommonAnanlyse!=null)
        toEntry(accioCommonAnanlyse);
        return accioCommonAnanlyse;
    }

    public AnalystStream createInstance(){
        return new AccioAnalysePlugin();
    }
}
